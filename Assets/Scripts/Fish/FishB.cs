...
public class FishB : PlayableFish
{
    ...
    {//#80FF80  #FF8080
        return $"<color=#80FF80>{fishData.durationTime + duraLevel * fishData.duraUpgradeRatio}초</color> 동안 획득하는 점수가 2배가 됩니다 ( 쿨타임 <color=#FF8080>{fishData.coolTime - coolLevel * fishData.coolUpgradeRatio}초</color> )";
    }
}
